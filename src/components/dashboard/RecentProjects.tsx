          ...
          >
            <div className="flex items-start justify-between mb-1.5 sm:mb-3">
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-1 sm:gap-2 mb-0.5 sm:mb-1">
                  <span className={`text-[10px] sm:text-xs px-1 sm:px-2 py-0.5 rounded ${sectorColors[project.sector as Sector]}`}>
            ...
            <div className="flex items-center justify-between text-[10px] sm:text-sm gap-2">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                <Progress value={project.progress} className="w-10 sm:w-20 h-1 sm:h-2" />
